				...
				<td  align=\"right\" valign=\"bottom\">
					<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
						<tr>
							...
							<td><input type=\"text\" name=\"impose_qty\" value=\"500\" size=\"5\" class=\"text\" style=\"height: 10; width: 35\"></td>
							<td>&nbsp;&nbsp;&nbsp;</td>
...
if ( $num_orderitems == 0 ) {
	...
	while ( $a = mysql_fetch_assoc($r_result) ) {
		...
		<tr bgcolor=\"$color\">
			...
			<td class=\"text\" height=\"$rowheight\">" . $a_item[ $a['ItemID'] ] . "
			
			</td>
			<td width=\"10\"><a href=\"javascript:;\" onClick=\"popupWin('../_orderpdfs/$a[ID]_preview_raster.jpg','','width=400,height=400,centered=yes');this.blur()\"><img border=0 src=\"images/icon-rastersmall.gif\"></a></td>
...
/*			<!--	<td class=\"text\" width=\"20\" nowrap align=\"right\" height=\"$rowheight\">
				...
				<td class=\"text\" height=\"$rowheight\">
					<!-- Description //-->*/
//				$a[Description] <span title=\"Name: long descriptions will be truncated so that they fit on the page without wrapping.\" class=\"text\">Name: long descriptions wi...</span>
